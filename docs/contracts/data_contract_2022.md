...
| Atingiu PV | string | original | no | dtype:error, missing:error, domain:warning |
| Ativo/ Inativo | string | structural_optional | no | dtype:error, missing:info, domain:info |
| Ativo/ Inativo__dup1 | string | structural_optional | no | dtype:error, missing:info, domain:info |
...
| Avaliador5 | string | structural_optional | yes | dtype:error, missing:info, domain:info |
| Avaliador6 | string | structural_optional | yes | dtype:error, missing:info, domain:info |
| Cf | Float64 | original | no | dtype:error, missing:error, domain:warning |
| Cg | Float64 | original | no | dtype:error, missing:error, domain:warning |
| Ct | Float64 | original | no | dtype:error, missing:error, domain:warning |
...
| Escola | string | structural_optional | no | dtype:error, missing:info, domain:info |
...
| INDE 2024 | Float64 | structural_optional | no | dtype:error, missing:info, domain:error |
| INDE 22 | Float64 | original | no | dtype:error, missing:info, domain:error |
| INDE 23 | Float64 | structural_optional | no | dtype:error, missing:info, domain:error |
| IPP | Float64 | structural_optional | no | dtype:error, missing:info, domain:error |
...
| Indicado | string | original | no | dtype:error, missing:error, domain:warning |
...
| Pedra 2024 | string | structural_optional | no | dtype:error, missing:info, domain:warning |
...
| Pedra 23 | string | structural_optional | no | dtype:error, missing:info, domain:warning |
...
| Rec Av3 | string | original | no | dtype:error, missing:info, domain:info |
| Rec Av4 | string | original | no | dtype:error, missing:info, domain:info |
