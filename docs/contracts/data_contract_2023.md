...
| Destaque IPV__dup1 | string | original | no | dtype:error, missing:info, domain:info |
...
| INDE 2023 | Float64 | original | no | dtype:error, missing:info, domain:error |
...
| Nº Av | Int64 | original | no | dtype:error, missing:warning, domain:error |
| Pedra 20 | string | original | no | dtype:error, missing:info, domain:warning |
| Pedra 2023 | string | original | no | dtype:error, missing:info, domain:warning |
